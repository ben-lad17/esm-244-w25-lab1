...
sfo_trees_df<-read_csv(here("data","sfo_trees","sfo_trees.csv")) |> 
  janitor::clean_names() # lazy load/single one use load (e.g., take in only clean_names from janitor package)
```
...
Are there more of some species than other species?
How many unique species are there?

How many counts of each observation by legal_status are there?
...
2) Filter all trees besides pine and oak
3) summarize counts of oaks and pines
